...
The VCF files with the filtered SNPs of a spatial and a temporal datasets of cultivated Senegalese plants used in the study are deposited [here](https://dataverse.ird.fr/dataverse/dynadiv) under the Datasets name "XXX".
