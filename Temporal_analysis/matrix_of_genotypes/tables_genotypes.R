...
bed <- "data/temp_chr3_101-189Mb_BED.bed"
...
write.table(snp_pc,file="SNPs_outliers_PCADAPT_TEMPORAL.txt",col.names=FALSE)
outlierSNPs<- "SNPs_outliers_PCADAPT_TEMPORAL.txt"

# 2. A VCF file with the samples ordered following the clusters identified in the population has to be used: 
vcfOrdered<-"data/temp_chr3_101-189Mb_ORDERED.vcf"
